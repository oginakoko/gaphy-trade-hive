  ...
  return (
    <div className="group glass-card rounded-xl overflow-hidden animate-fade-in-up h-full flex flex-col transition-all duration-300 hover:border-brand-green/40 hover:shadow-xl hover:shadow-brand-green/10">
      ...
      <div className="p-4 flex flex-col flex-grow">
          ...
          <div className="flex items-center justify-end text-gray-400 mt-auto pt-3 border-t border-white/10">
              <a href={ad.link_url} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-brand-green">
                  Learn More
